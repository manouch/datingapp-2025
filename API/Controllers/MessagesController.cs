...
public class MessagesController(IUnitOfWork uow) : BaseApiController
{
  ...
  public async Task<ActionResult<IReadOnlyList<MessageDto>>> GetMessageThread(string recipentId)
  {
    return Ok(await uow.MessageRepository.GetMessageThread(User.GetMemberId(), recipentId));
  }
